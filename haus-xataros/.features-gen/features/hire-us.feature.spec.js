...
test.describe('Hire Us (Consulting)', () => {
  ...
  test('Intro section is visible with headline', async ({ Then, page }) => { 
    await Then('I should see the heading "Story-led consulting for projects that need clarity, structure, and a sharper point of view."', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":10,"pickleLine":9,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"Given I am on the \"/hire-us\" page","isBg":true,"stepMatchArguments":[{"group":{"start":12,"value":"\"/hire-us\"","children":[{"start":13,"value":"/hire-us","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":11,"gherkinStepLine":10,"keywordType":"Outcome","textWithKeyword":"Then I should see the heading \"Story-led consulting for projects that need clarity, structure, and a sharper point of view.\"","stepMatchArguments":[{"group":{"start":25,"value":"\"Story-led consulting for projects that need clarity, structure, and a sharper point of view.\"","children":[{"start":26,"value":"Story-led consulting for projects that need clarity, structure, and a sharper point of view.","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
