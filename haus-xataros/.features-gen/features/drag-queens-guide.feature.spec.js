// Generated from: features/drag-queens-guide.feature
import { test } from "playwright-bdd";

test.describe('The Drag Queen\'s Guide (Blog)', () => {

  test.beforeEach('Background', async ({ Given, page }, testInfo) => { if (testInfo.error) return;
    await Given('I am on the "/drag-queens-guide" page', null, { page }); 
  });
  
  test('Landing page has its own distinct branding', async ({ Then, page }) => { 
    await Then('I should see a heading for "The Drag Queen\'s Guide"', null, { page }); 
  });
